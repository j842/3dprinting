...
--- 
 ...
 -- main cube
  ...
  for a=0,360,ad do
    wf=difference(wf,
      translate(0,-kw/2,0)*rotate(a,Z)*translate(0,-15*k,0)*rotate(45,X)*cylinder(t,kw))
    wf=difference(wf,
      translate(0,-kw/2,0)*rotate(a+0.5*ad,Z)*translate(0,-20*k,0)*rotate(45,X)*cylinder(t,kw))
  end
